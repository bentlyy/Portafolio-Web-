...
export type TranslationSet = {
  ...
  infra: { subtitle: string; title: string; description: string; provider: string; statusOnline: string; statusMaintenance: string; statusUpdating: string; statusError: string }
...
export const translations: Record<Lang, TranslationSet> = {
  ...
  en: {
    ...
    infra: { subtitle: "ARCHITECTURE v1.0", title: "INFRASTRUCTURE", description: "How services are distributed in production. Each platform runs in its own environment, with independent resources and deploy strategies.", provider: "PROVIDER", statusOnline: "ONLINE", statusMaintenance: "ON HOLD", statusUpdating: "UPDATING", statusError: "DOWN" },
