...
export const projects = [
  ...
  {
    title: "Transporte",
    description: "Transport Management System (TMS) en tiempo real para flota de carga internacional: clientes, conductores, camiones, viajes, geocercas y facturación, con tracking GPS en vivo.",
    ...
    features: [
      ...
      "Motor de simulación de rutas y posiciones GPS (ingnition, combustible, velocidad)",
      "Facturación, autenticación JWT + refresh y roles RBAC (superadmin/admin/driver)",
    ],
  },
  {
    title: "TypeForge",
