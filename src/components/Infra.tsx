...
const infra = [
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Transporte", url: "https://transporte.amgdeveloper.cl", status: "online" as ServiceStatus },
    ],
...
export default function Infra() {
  ...
  return (
    <section id="infra" className="relative w-full h-full flex items-start justify-center overflow-y-auto pt-[61px] md:pt-[69px]">
